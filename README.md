...
### Tutorial
* [ensemple.py](https://github.com/sydney-machine-learning/ensemble-learning-tutorial/blob/master/ensemple.py) was written by Rohitash Chandra. Gemini was used to make [ensemble-gemini.py](https://github.com/sydney-machine-learning/ensemble-learning-tutorial/blob/master/ensemble-gemini.py) and [ensemble-tutorial.ipnyb] (https://github.com/sydney-machine-learning/ensemble-learning-tutorial/blob/master/ensemble-tutorial.ipynb)
